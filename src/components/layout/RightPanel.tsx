...
export function RightPanel() {
  ...
  return (
    <div className="hidden lg:flex flex-col w-[300px] bg-white border-l border-gray-200 p-4 flex-shrink-0">
      {/* Akun Gmail */}
      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl mb-4">
        ...
        <div className="flex-1">
          <div className="text-sm font-medium text-gray-900">Zakie Alelm</div>
          <div className="text-xs text-gray-500">zakie.alelm@gmail.com</div>
          <div className="text-xs text-gray-500">+62822xxx</div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="text-xs text-gray-500">{hijriDate.day} {hijriDate.month} {hijriDate.year}H</div>
      </div>

      {/* Waktu Saat Ini */}
      <div className="text-center mb-4">
        <span className="text-4xl font-black text-[#0b3d2e]">{hours}:{minutes}</span>
      ...
      {/* Jadwal Sholat */}
      <div className="mb-4">
        <h3 className="text-sm font-bold text-[#0b3d2e] mb-2">Jadwal Sholat</h3>
        {prayerLoading || locationLoading ? (
          ...
          <button
            ...
            className="text-xs text-[#0b3d2e] underline"
          >
            Aktifkan lokasi
          </button>
        )}
